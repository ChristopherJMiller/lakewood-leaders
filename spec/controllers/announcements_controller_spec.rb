...
RSpec.describe AnnouncementsController, type: :controller do
  ...
  let(:valid_parameters) do
    {title: 'Test Announcement', post: 'Test post', user_id: user_admin.id}
  end

  let(:invalid_parameters) do
    {title: 'Test Announcement', post: nil, user_id: user_admin.id}
  end
    ...
    context 'with a valid announcement' do
      context 'as an admin' do
        context 'with valid parameters' do
          ...
          it 'updates the requested announcement\'s title' do
            announcement.reload
          ...
          it 'updates the requested announcement\'s title' do
            announcement.reload
            expect(announcement.post).to eq(valid_parameters[:post])
          end
        end
