...
RSpec.describe User, type: :model do
  ...
  it 'should be valid with a missing parent email' do
  ...
  it 'should not be valid with an invalid parent email' do
  ...
  it 'should not be valid with an invalid parent verified' do
